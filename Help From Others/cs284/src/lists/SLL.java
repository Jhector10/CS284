...
import lists.SLL1.Node;

//import basics.Pair;
//Simrun Heir and Abdellah Amrhar
...
//	}
	...
	public SLL<E> cloneR(Node<E> current){
		SLL<E> cloneList = new SLL<E>();
		if(current==null) {
			return cloneList;
		} else {
			cloneList.add(current.data);
			return cloneR(current.next);
		}
	}
