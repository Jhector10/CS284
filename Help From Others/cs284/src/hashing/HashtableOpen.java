...
public class HashtableOpen <K, V> extends AbstractMap <K, V>
	...
	public static class Entry<K, V> implements Map.Entry<K, V> 
		...
		public V setValue(V val) 
			{V oldVal = value;value = val;return oldVal;}
	...
	/*
	 * retrieves the value of the key given
	 ...
	 * 
	 * if the key is not in the table, insert a new entry containing the key and value and return val
	 */
